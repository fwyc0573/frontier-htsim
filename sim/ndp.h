...
// Enable NDP timeout-based retransmission by default in this fork.
// This prevents connections from getting stuck forever when early packets are dropped
// (e.g., small buffers + strong incast/all-to-all).
//
// If you want upstream behavior (no timeout retransmission), compile with:
//   -DDISABLE_RESEND_ON_TIMEOUT
#ifndef DISABLE_RESEND_ON_TIMEOUT
